      ...
      <div className="prose prose-slate lg:prose-lg max-w-none mx-0 md:mx-4">
        ...
        <div>
          ...
          <div>
            ...
            <ol>
              <li>
                Undang-Undang Nomor 23 Tahun 2014 tentang Pemerintahan Daerah: Undang-undang ini mengatur pembagian urusan pemerintahan antara pemerintah pusat dan daerah, termasuk urusan komunikasi dan informatika.
              </li>
              <li>
                Peraturan Pemerintah Nomor 18 Tahun 2016 tentang Perangkat Daerah: Peraturan ini memberikan pedoman mengenai pembentukan dan susunan perangkat daerah, termasuk Diskominfo.
              </li>
              <li>
                Peraturan Menteri Komunikasi dan Informatika Republik Indonesia Nomor 13 Tahun 2016 tentang Hasil Pemetaan Urusan Pemerintahan Daerah di Bidang Komunikasi dan Informatika: Peraturan ini memetakan urusan pemerintahan di bidang komunikasi dan informatika yang menjadi kewenangan daerah.
              </li>
              <li>
                Peraturan Menteri Komunikasi dan Informatika Nomor 4 Tahun 2024 tentang Penyelenggaraan Urusan Pemerintahan Konkuren Bidang Komunikasi dan Informatika: Peraturan ini mengatur penyelenggaraan urusan pemerintahan yang menjadi kewenangan bersama antara pemerintah pusat dan daerah di bidang komunikasi dan informatika.
              </li>
              <li>
                Peraturan Daerah Kabupaten Serdang Bedagai Nomor 6 Tahun 2016 tentang Pembentukan Perangkat Organisasi: Peraturan ini menetapkan pembentukan perangkat daerah di Kabupaten Serdang Bedagai, termasuk Diskominfo.
              </li>
              <li>
                Peraturan Bupati Serdang Bedagai Nomor 36 Tahun 2022 tentang Organisasi dan Tata Kerja Perangkat Daerah pada Pemerintah Daerah Kabupaten Serdang Bedagai: Peraturan ini mengatur struktur organisasi dan tata kerja perangkat daerah di Kabupaten Serdang Bedagai.
              </li>
              <li>
            ...
            <ol>
              <li>
                ...
                <ul>
                  <li>Meningkatkan penyebarluasan informasi melalui media massa.</li>
                  <li>Meningkatkan keterbukaan informasi publik di Organisasi Perangkat Daerah (OPD).</li>
                  <li>Meningkatkan penyebarluasan informasi melalui publikasi dan penerbitan.</li>
                  <li>Meningkatkan promosi potensi Kabupaten Serdang Bedagai.</li>
                  <li>Meningkatkan minat masyarakat di bidang kehumasan.</li>
                  <li>Meningkatkan pengetahuan Sumber Daya Manusia (SDM) dalam bidang komunikasi dan informasi.</li>
                </ul>
              </li>
              <li>Meningkatkan Pembangunan Infrastruktur Teknologi Informatika yang Optimal
                <ul>
                  <li>Meningkatkan sarana dan prasarana informasi dan komunikasi yang berbasis teknologi informasi.</li>
                  <li>Meningkatkan pelayanan jaringan informasi dan komunikasi.</li>
                </ul>
              </li>
              <li>Meningkatkan Penggunaan Sistem Informasi yang Berbasis Teknologi Informasi
                <ul>
                   <li>Meningkatkan pengelolaan sistem informasi melalui teknologi informatika.</li>
                   <li>Meningkatkan pelayanan publik yang berbasis teknologi informasi.</li>
                </ul>
              </li>
            </ol>
